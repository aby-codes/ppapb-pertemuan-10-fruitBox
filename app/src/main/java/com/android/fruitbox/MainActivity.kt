...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var fruitAdapter = FruitAdapter(generateBuahData()) { buah ->
    ...
    fun generateBuahData(): List<Fruit> {
        return listOf(
            ...
            Fruit(name = "Delima", price = "20000", pict = R.drawable.delima, description = "Delima adalah buah dengan biji kecil yang terbungkus dalam biji merah yang empuk. Buah ini memiliki rasa manis dengan sentuhan asam. Delima dikenal sebagai sumber antioksidan yang kuat dan memiliki manfaat kesehatan yang beragam.s"),
        )
    }
